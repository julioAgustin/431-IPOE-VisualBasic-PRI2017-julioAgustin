...
Module modPrincipal
    ...
    Public conexion As New SqlConnection("data source=MARIO-PC\SQLEXPRESS;initial catalog=stock;uid=sa;pwd=12345")
    'Public conexion As New SqlConnection("data source= MARIO-PC\SQLEXPRESS;initial catalog=stock; Integrated Security= true")
